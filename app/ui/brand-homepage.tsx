    ...
    <main className={styles.page}>
        ...
        <div className={styles.cinemaFrame}>
          ...
          <header className={styles.brandBar}>
            ...
            <nav className={styles.heroNav} aria-label="首页导航">
              ...
              <a href="#growth">爆款增长</a>
              <a href="#service">询盘承接</a>
              <a href="#product">增长链路</a>
              <a className={styles.navAction} href="mailto:19653282176@163.com?subject=申请体验灵枢 AI">
                申请体验
              </a>
            </nav>
          </header>
          ...
          <div className={styles.hero}>
            <p className={styles.eyebrow}>LINGSHU AI · GLOBAL GROWTH SYSTEM</p>
            <h1 id="brand-hero-title">
              让内容持续触达，
              <span>让高价值商机不再掉线</span>
            </h1>
            <p className={styles.summary}>
              从内容机会到询盘承接，让海外获客成为一条持续运转的增长链路。
            </p>
            <div className={styles.heroActions}>
              <a className={styles.heroAction} href="#content-ecosystem">
                探索完整增长链路 <b aria-hidden="true">↘</b>
              </a>
      ...
      <section className={styles.closingCover} id="contact" aria-labelledby="closing-title">
        ...
        <div className={styles.closingContent} data-reveal>
          <span>READY FOR THE NEXT GROWTH</span>
          <h2 id="closing-title">
            让下一条内容，
            <strong>开始带回真正的商机</strong>
          </h2>
          <p>把你的产品、社媒内容和客户承接，连接成一条持续运转的海外增长链路。</p>
          <div>
            <a className={styles.closingAction} href="mailto:19653282176@163.com?subject=申请体验灵枢 AI">
              申请体验 <b aria-hidden="true">↗</b>
            </a>
            <a className={styles.closingMail} href="mailto:19653282176@163.com">
              19653282176@163.com
            </a>
          </div>
        </div>
