...
const sections: LegalSection[] = [
  { id: "current", title: "当前使用情况", content: <><p>当前公开网站未主动部署 Meta Pixel、TikTok Pixel、Google Analytics 或用于跨网站定向广告的第三方追踪 Cookie。访问网站时，托管与安全基础设施仍可能处理必要的网络请求信息，以传输页面、防止滥用和排查故障。</p><p>预约表单由 FormSubmit 提供传输服务。提交表单会将你填写的信息发送至该服务并转发至我们的业务邮箱；是否产生其自身必要技术记录，受该服务政策约束。</p></> },
...
export default function CookiesPage() {
  return <LegalDocument eyebrow="COOKIES" title="Cookie 与追踪技术" summary="透明说明当前网站用了什么、没用什么，以及未来增加广告衡量能力时会如何告知。" sections={sections} />;
}
